...
module.exports = function (proxy, allowedHost) {
  return {
    ...
    // https://github.com/facebookincubator/create-react-app/issues/2233 While we're
    ...
    before(app) {
      ...
      // host and port.
      // https://github.com/facebookincubator/create-react-app/issues/2272#issuecomment
      // -302832432
